...
from cnn_classifier_stepwise_seqwise.networks.cnn_seqwise_classifier import \
    ClassifierSeqwiseOneLayerFeatureExtractorWithoutCnn
...
def experiment(variant, args):
    ...
    seqwise_classifier = ClassifierSeqwiseOneLayerFeatureExtractorWithoutCnn(
