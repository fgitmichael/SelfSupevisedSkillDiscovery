...
from seqwise_cont_skillspace.base.rnn_classifier_base import RnnStepwiseSeqwiseClassifierBase
...
class RnnStepwiseSeqwiseClassifierHighdimusingvae(RnnStepwiseSeqwiseClassifierBase):
    ...
    def create_stepwise_classifier(
        ...
        return VaeRegressorWithreconvar(
            input_size=feature_dim,
            latent_dim=2,
            output_size=skill_dim,
