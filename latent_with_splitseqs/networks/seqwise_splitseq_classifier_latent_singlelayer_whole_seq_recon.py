...
class SeqwiseSplitseqClassifierSingleLayeredWholeSeqRecon(SplitSeqClassifierBase):
    ...
    def __init__(self,
                 *args,
                 ...
                 obs_dim: int,
                 skill_dim: int,
                 latent_net: OneLayeredStochasticLatent,
