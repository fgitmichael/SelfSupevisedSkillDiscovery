...
from diayn_seq_code_revised.data_collector.seq_collector_revised_discrete_skills \
    import SeqCollectorRevisedDiscreteSkills
...
def experiment(variant, args):
    ...
    algorithm = SeqwiseAlgoRevisedDiscreteSkillsHighdim(
        ...
        seq_len=seq_len,
        seq_len_eval=seq_len//2 if seq_len > 100 else seq_len,
